...
var knownTypes = map[string]schemaType{
	...
	model.FilterAugment.Type: {
		schema: model.FilterAugment,
		object: &FilterAugment{
			TypeMeta: meta_v1.TypeMeta{
				Kind:       "FilterAugment",
				APIVersion: apiVersion(&model.FilterAugment),
			},
		},
		collection: &FilterAugmentList{},
	},
}
...
// FilterAugment is the generic Kubernetes API object wrapper
...
// GetSpec from a wrapper
func (in *FilterAugment) GetSpec() map[string]interface{} {
	return in.Spec
}

// SetSpec for a wrapper
func (in *FilterAugment) SetSpec(spec map[string]interface{}) {
	in.Spec = spec
}

// GetObjectMeta from a wrapper
func (in *FilterAugment) GetObjectMeta() meta_v1.ObjectMeta {
	return in.ObjectMeta
}

// SetObjectMeta for a wrapper
func (in *FilterAugment) SetObjectMeta(metadata meta_v1.ObjectMeta) {
	in.ObjectMeta = metadata
}

// FilterAugmentList is the generic Kubernetes API list wrapper
type FilterAugmentList struct {
	meta_v1.TypeMeta `json:",inline"`
	meta_v1.ListMeta `json:"metadata"`
	Items            []FilterAugment `json:"items"`
}

// GetItems from a wrapper
func (in *FilterAugmentList) GetItems() []IstioObject {
	out := make([]IstioObject, len(in.Items))
	for i := range in.Items {
		out[i] = &in.Items[i]
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FilterAugment) DeepCopyInto(out *FilterAugment) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	out.Spec = in.Spec
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FilterAugment.
func (in *FilterAugment) DeepCopy() *FilterAugment {
	if in == nil {
		return nil
	}
	out := new(FilterAugment)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *FilterAugment) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FilterAugmentList) DeepCopyInto(out *FilterAugmentList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	out.ListMeta = in.ListMeta
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]FilterAugment, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FilterAugmentList.
func (in *FilterAugmentList) DeepCopy() *FilterAugmentList {
	if in == nil {
		return nil
	}
	out := new(FilterAugmentList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *FilterAugmentList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
